/*
Define Main Test cases related --> Login user add itmes to cart
1.Declare import -
2.options -VU
3.Test Life cycle -Init -one time declaration
4.Test Life cycle -Setup
5.Test Life Cycle -Defalut function -VU main function 
6.Test Life cycle -Teardown -cleanup 
*/
...
/*2.Options .We need to declare the options 
Exculde the harcode of the value ,we have configured this inside env.sh file ,User will pass this at runtime
...
export default function main() {
    ...
    group("Login user searching for the product - https://stylishop.com/ae/en/", function () {
